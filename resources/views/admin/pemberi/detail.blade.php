            ...
            <table style = border : none;>
                <tbody>
                        ...
                        <tr>
                            ...
                            <td><h5> &emsp; Rp. {{number_format($dataProfil->zakat_bayar,2,',','.')}}</h5></td>
                        </tr>
                </tbody>
            </table>

            <div class="modal-footer">
                <a href="/pemberi" type="button" class="btn btn-secondary">Kembali</a>
                <button type="submit" name="tombol" class="btn btn-warning" data-bs-toggle="modal" data-bs-target="#formDataEdit">Edit</button>
                <form action="/pemberi/{{ $dataProfil->id_users }}" method="post" class="d-inline">
                    @method('delete')
                    @csrf
...
<div class="modal fade" id="formDataEdit" tabindex="-1" aria-labelledby="modalLabel" aria-hidden="true">
    <div class="modal-dialog">
        ...
        <div class="modal-body">
            <form action="/pemberi/{{ $dataProfil->id_users }}" method="post">
                @method('patch')
                @csrf
                <div class="mb-3">
